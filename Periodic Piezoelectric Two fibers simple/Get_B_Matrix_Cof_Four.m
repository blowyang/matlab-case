function [B_Cof_Pos_j,B_Cof_Neg_j]=Get_B_Matrix_Cof_Four(N,R2,x2,a,km,j)
...
B_Cof_Pos_j=[-km*L2_Pos_j*S0+zL4_Conj_Pos_j*conj(S0),L2_Conj_Pos_j*conj(S0)];
B_Cof_Neg_j=[-km*L2_Neg_j*S0+zL4_Conj_Neg_j*conj(S0),L2_Conj_Neg_j*conj(S0)];
