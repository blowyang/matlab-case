function [A_Cof_Re,A_Cof_Im,B_Cof_Re,B_Cof_Im]=Get_AB_Matrix_Cof_One(N,M,R1,R2,x1,x2,a,j)
...
for np=1:(NP-1)
    ...
    [A_Cof,B_Cof]=AB_Matrix_Cof_One(N,M,R1,R2,x1,x2,a,zi);
