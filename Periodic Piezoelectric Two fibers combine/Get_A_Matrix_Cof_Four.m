function [A_Cof_Pos_j,A_Cof_Neg_j]=Get_A_Matrix_Cof_Four(N,R1,R2,x1,x2,Gm,km,Gf2,kf2,j)
...
A_Cof_Pos_j=[zero_list,zero_list,Gm/Gf2*kf2*L72_Pos_j*S1-Gm/Gf2*zL82_Conj_Pos_j*conj(S1),-Gm/Gf2*L72_Conj_Pos_j*conj(S1),...
...
A_Cof_Neg_j=[zero_list,zero_list,Gm/Gf2*kf2*L72_Neg_j*S1-Gm/Gf2*zL82_Conj_Neg_j*conj(S1),-Gm/Gf2*L72_Conj_Neg_j*conj(S1),...
