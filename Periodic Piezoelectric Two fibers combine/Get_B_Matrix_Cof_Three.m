function B_Cof=Get_B_Matrix_Cof_Three(N,M,R1,R2,x1,x2,a,j)
...
inte_B_Cof=0;
z0=zd+R2*exp(1i*0);
B_Cof=B_Matrix_Cof_Three(N,M,R1,R2,x1,x2,a,z0);
inte_B_Cof=inte_B_Cof+h/6*B_Cof*exp(-j*1i*0);
zNP=zd+R2*exp(1i*2*pi);
B_Cof=B_Matrix_Cof_Three(N,M,R1,R2,x1,x2,a,zNP);
inte_B_Cof=inte_B_Cof+h/6*B_Cof*exp(-j*1i*2*pi);

for np=1:(NP-1)
    zi=zd+R2*exp(1i*np*h);
    B_Cof=B_Matrix_Cof_Three(N,M,R1,R2,x1,x2,a,zi);
