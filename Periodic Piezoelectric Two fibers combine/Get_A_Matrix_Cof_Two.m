function [A_Cof_Pos_j,A_Cof_Neg_j]=Get_A_Matrix_Cof_Two(N,R1,R2,x1,x2,Gm,km,Gf1,kf1,j)
...
if j>=2
    zL31_Conj_Pos_One_j(1,j-1)=-x1*(j-1)/R1;   
end
zL31_Conj_Pos_Two_j=zeros(1,N);
if j>=3
    zL31_Conj_Pos_Two_j(1,j-2)=-(j-2);
end
...
A_Cof_Pos_j=[Gm/Gf1*kf1*L71_Pos_j*S1-Gm/Gf1*zL81_Conj_Pos_j*conj(S1),-Gm/Gf1*L71_Conj_Pos_j*conj(S1),zero_list,zero_list,...
    -km*L11_Pos_j*S1+zL31_Conj_Pos_j*conj(S1),-km*L12_Pos_j*S1+zL32_Conj_Pos_j*conj(S1),...
    L11_Conj_Pos_j*conj(S1),L12_Conj_Pos_j*conj(S1)];

A_Cof_Neg_j=[Gm/Gf1*kf1*L71_Neg_j*S1-Gm/Gf1*zL81_Conj_Neg_j*conj(S1),-Gm/Gf1*L71_Conj_Neg_j*conj(S1),zero_list,zero_list,...
    -km*L11_Neg_j*S1+zL31_Conj_Neg_j*conj(S1),-km*L12_Neg_j*S1+zL32_Conj_Neg_j*conj(S1),...
