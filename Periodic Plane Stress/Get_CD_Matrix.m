function [C_Matrix,D_Matrix]=Get_CD_Matrix(K,N,M,R,a,km,Gm)
...
for k=1:K
    ...
    [L1_zk_AB,L2_zk_AB,L3_zk_AB,L4_zk_AB,L5_zk_AB,L6_zk_AB,~,~]=Get_L_List(N,M,R,a,zk_AB);
    [L1_zk_CD,L2_zk_CD,L3_zk_CD,L4_zk_CD,L5_zk_CD,L6_zk_CD,~,~]=Get_L_List(N,M,R,a,zk_CD);
    [L1_zk_DB,L2_zk_DB,L3_zk_DB,L4_zk_DB,L5_zk_DB,L6_zk_DB,~,~]=Get_L_List(N,M,R,a,zk_DB);
    [L1_zk_CA,L2_zk_CA,L3_zk_CA,L4_zk_CA,L5_zk_CA,L6_zk_CA,~,~]=Get_L_List(N,M,R,a,zk_CA);
    %C_Matrix
